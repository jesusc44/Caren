		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Castigo-incobrables",
									"targetURL": "#zincobrableszincobrables-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zincobrableszincobrables-display": {
								"semanticObject": "zincobrableszincobrables",
								"action": "display",
								"description": "Castigo-incobrables",
								"title": "Castigo-incobrables",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zincobrables.zincobrables",
									"url": sap.ui.require.toUrl("zincobrables/zincobrables")
								}
							}
						}
					}
