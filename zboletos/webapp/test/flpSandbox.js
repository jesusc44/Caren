		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Actualización Nro Boletos",
									"targetURL": "#zboletoszboletos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zboletoszboletos-display": {
								"semanticObject": "zboletoszboletos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zboletos.zboletos",
									"url": sap.ui.require.toUrl("zboletos/zboletos")
								}
							}
						}
					}
