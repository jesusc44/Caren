		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zgestionchequeszgestioncheques-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgestionchequeszgestioncheques-display": {
								"semanticObject": "zgestionchequeszgestioncheques",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgestioncheques.zgestioncheques",
									"url": sap.ui.require.toUrl("zgestioncheques/zgestioncheques")
								}
							}
						}
					}
